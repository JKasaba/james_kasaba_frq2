  ...
  11:	8d 5d b4             	lea    -0x4c(%ebp),%ebx
{
  ...
  f1:	53                   	push   %ebx
  f2:	e8 19 03 00 00       	call   410 <unlock>
 ...
 123:	50                   	push   %eax
 124:	50                   	push   %eax
 125:	68 52 09 00 00       	push   $0x952
 12a:	6a 01                	push   $0x1
 12c:	e8 4f 04 00 00       	call   580 <printf>
                wait();
 131:	e8 f7 02 00 00       	call   42d <wait>
 136:	e8 f2 02 00 00       	call   42d <wait>
            printf(1, "Children Completed\n");
 13b:	5a                   	pop    %edx
 13c:	59                   	pop    %ecx
 13d:	68 62 09 00 00       	push   $0x962
 142:	6a 01                	push   $0x1
 144:	e8 37 04 00 00       	call   580 <printf>
            printf(1, "Parent Executing\n");
 149:	5b                   	pop    %ebx
 14a:	5f                   	pop    %edi
 14b:	68 76 09 00 00       	push   $0x976
 150:	6a 01                	push   $0x1
 152:	e8 29 04 00 00       	call   580 <printf>
            printf(1, "Parent Exiting\n");
 157:	58                   	pop    %eax
 158:	5a                   	pop    %edx
 159:	68 88 09 00 00       	push   $0x988
 15e:	6a 01                	push   $0x1
